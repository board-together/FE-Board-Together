export const getRandyUserDataBorrow = {
  user: {
    borrowedGames: [],
    id: "2",
    userGames: [
      ...
      },
      {
        ...
        game: {
          ...
          "thumbUrl": "https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1629324738308.jpg",
          "imageUrl": "https://s3-us-west-1.amazonaws.com/5cc.images/games/uploaded/1629324738308.jpg"
        },
        gameId: 23,
        id: "702",
        status: 0,
...
export const getHoneyUserDataBorrow = {
  user: {
    borrowedGames: [],
    id: "2",
    userGames: [
...
export const getHoneyUserDataBorrowAFTER = {
  user: {
    borrowedGames: [],
    id: "2",
    userGames: [{
...
export const getAllUsersDataBorrow = {
  users: [
    {
      id: "9",
      username: "honey"
...
export const updatedGameResponse = {
  "updateUserGame": {
    "userGame": {
      "id": "702",
      "borrowerId": 2,
...
export const getRandyUserDataAfterAdd = {
  user: {
    borrowedGames: [],
    id: "2",
    userGames: [
